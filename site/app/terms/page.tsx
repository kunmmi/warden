...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms of use for the warden open-source software and website.",
};
  ...
  return (
    <div className="wrap" style={{ maxWidth: 760, padding: "40px 24px 80px" }}>
      <article className="doc-body">
        ...
        <p>
          warden is free, open-source software published under the MIT License. This page explains
          the terms on which you use the software and this website. By installing or using the
          software, you agree to these terms. If you don&apos;t agree, don&apos;t use it.
        </p>

        <h2>1 · The software is provided “as is”</h2>
        <p>
          warden is provided under the MIT License, without warranty of any kind — express or
        ...
        <p>
          warden is a tool for building and running automated trading strategies. It is{" "}
        ...
        <p>
          warden is self-hosted and non-custodial. It runs on your machine, generates and stores keys
          locally in your <code className="inline">~/.warden</code> directory, and interacts with
          BNB Smart Chain directly. We never take custody of your private keys or on-chain funds, and
          we cannot access, freeze, reverse, or recover them. You are responsible for:
        </p>
        <ul>
          <li>Securing the machine warden runs on and backing up your keys.</li>
        ...
        <p>
          warden can connect to third-party services you configure — such as blockchain RPC and
          bundler providers, your chosen LLM provider, Telegram, and transcription providers. Your
          use of those services is governed by their own terms and prices. We are not responsible for
          their availability, conduct, or fees, and API keys you provide are used only to call the
          services you point them at.
        </p>

        <h2>5 · Acceptable use</h2>
        <p>
          Use warden lawfully. Do not use it to violate any law or regulation, to infringe others&apos;
        ...
        <p>
          ...
          sites (such as GitHub) that we don&apos;t control. We may update or remove content at any
          time.
        </p>
        ...
        <div className="callout" style={{ marginTop: 40 }}>
          ...
          substitute for legal advice. If you operate warden commercially or at scale, consult a
          lawyer.
        </div>
      </article>
    </div>
